...
const props = defineProps<{ item: NavGroup }>()
  ...
  >
    <div class="nav-group-label" @click="isGroupOpen = !isGroupOpen">
      ...
      <TransitionGroup name="transition-slide-x">
        ...
        <span v-show="!hideTitleAndBadge" class="nav-item-meta">
          <Component
            :is="layoutConfig.app.iconRenderer || 'div'"
...
'@
Set-Content -Path "src/@layouts/components/VerticalNavGroup.vue" -Value $content -Encoding UTF8